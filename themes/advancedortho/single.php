	...
	<div class="row">
		<div class="col-md-4">
			<div class="left-single">
				<h2 class="mobile">Dr. <?= get_the_title($ID); ?></h2>
		...
		<div class="col-md-8">
			<div class="content">
				<h2 class="desktop">Dr. <?= get_the_title($ID); ?></h2>
				<p class="text-info"><b>Specializes</b> in <?= get_post_meta($post->ID, 'wpcf-doc-special', true); ?></p>

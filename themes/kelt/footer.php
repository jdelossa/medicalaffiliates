<footer>
	<div class="container">
		<div class="ribbon">
			<div class="row">
				<div class="col-sm-12">
					<p class="affiliation text-center">© Copyright <?php echo date('Y');?> - Winthrop University Hospital | <a href="http://wuhwebsites.winthrop.org/kelt_wordpress/patient-privacy-policy/" style="font-size: 10px !important; text-decoration: underline;">Patient Privacy Policy</a></p>
				</div>
			</div>
		</div>
	</div>

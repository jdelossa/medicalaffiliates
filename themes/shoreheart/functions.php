...
if( !function_exists("wp_bootstrap_theme_styles") ) {  
    function wp_bootstrap_theme_styles() { 
        ...
        // Bootstrap
        wp_register_style('bootstrap-style', get_template_directory_uri() . '/library/bootstrap/css/bootstrap.min.css');
        wp_enqueue_style('bootstrap-style');

        // Bootstrap Theme
        wp_register_style('bootstrap-theme-style', get_template_directory_uri() . '/library/bootstrap/css/bootstrap-theme.min.css');
...
if( !function_exists( "wp_bootstrap_theme_js" ) ) {  
  function wp_bootstrap_theme_js(){
    ...
    wp_register_script( 'bootstrap', 
      get_template_directory_uri() . '/library/bootstrap/js/bootstrap.js', 
      array('jquery'), 
      '1.2' );
